              ...
              +"<div class='shop_item_details'>"
                +"<div class='row'>"
                  +"<div class='col-50'>"
                    ...
                    +"<div><b>$ "+v.valor+"</b></div>"
                    +"<h4 class='shop_item_price' style='position:initial !important;'>Comentarios:</h4>"
                    +"<div id='com"+i2+"' class='assistant-comments'></div>"
                  +"</div>"
                  +"<div class='col-50'>"
                    +"<div id='assistantData-" + v.idasistente + "' class='assistant-data'>"
                      ...
                      +"<h4 class='shop_item_price' style='position:initial !important;'>Experiencia: </h4>"
                      +"<p>"+v.descripcion+"</p>"
                    +"</div>"
                  +"</div>"
                +"<div>"
